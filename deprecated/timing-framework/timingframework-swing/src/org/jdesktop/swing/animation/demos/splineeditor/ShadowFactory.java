 ...
 * blur</i> and <i>high quality blur</i>. You can select your preferred
 * algorithm by setting the appropriate rendering hint:
 * 
 * <pre>
 ...
 * </pre>
 * 
 * The default rendering algorithm is <code>VALUE_BLUR_QUALITY_FAST</code>.
 * </p>
 * <p>
 ...
 * faster) with the <i>fast quality blur</i>.
 * </p>
 * <h2>Generating a Shadow</h2>
 * <p>
 * A shadow is generated as a <code>BufferedImage</code> from another
 ...
 * </pre>
 * 
 * The resulting image is of type <code>BufferedImage.TYPE_INT_ARGB</code>. Both
...
public class ShadowFactory {
   ...
   * for <code>KEY_BLUR_QUALITY</code>.
   */
   ...
   * This algorithm does not guarantee a better rendering quality and should not
   * be used.
   */
   ...
   * are provided as <code>Integer</code> instances.
   * </p>
   */
   ...
   * <p>
   * When the property change event is fired, the old value and the new value
   * are provided as <code>Float</code> instances.
   */
  ...
  /**
   * Creates a default good looking shadow generator. The default shadow factory
  ...
  /**
   * Maps the specified rendering hint <code>key</code> to the specified
   * <code>value</code> in this <code>SahdowFactory</code> object.
   * 
   * @param key
   ...
   * <p>
   * Consecutive calls to {@link #createShadow} will all use this color until it
   * is set again.
   * <p>
  ...
  public void setOpacity(final float shadowOpacity) {
    ...
    changeSupport.firePropertyChange(OPACITY_CHANGED_PROPERTY, new Float(oldOpacity), new Float(this.opacity));
  }
   ...
   * generation performances. The greater this value, the longer it will take to
   * generate the shadow. Remember the generated shadow image dimensions are
   * computed as follow:
   * <ul>
   * <li>new width = original width + 2 * shadow size</li>
   * <li>new height = original height + 2 * shadow size</li>
   * </ul>
   * The size cannot be negative. If you provide a negative value, the size will
   * be 0 instead.
   * 
   * @param shadowSize
  ...
  /**
   * Generates the shadow for a given picture and the current properties of the
   * factory.
   * <p>
   ...
   * </ul>
   * <p>
   * The time taken by a call to this method depends on the size of the shadow,
   * the larger the longer it takes, and on the selected rendering algorithm.
   * 
   * @param image
  ...
  private BufferedImage createShadowFast(final BufferedImage src) {
    ...
    for (int srcY = 0, dstOffset = left * dstWidth; srcY < srcHeight; srcY++) {
      ...
      for (int srcX = 0; srcX < srcWidth; srcX++) {
        ...
        aSum -= aHistory[historyIdx]; // subtract the oldest pixel from
        // the sum
