...
public class TestSimpleStore {
    ...
    public void testFindTopicsByClass() {
        ...
        assertEquals(1, simpleStore.findTopicsByClass(Yellow.class).size());
    }

    @Test
    public void testCreatingObjectByTopicId() {
        Yellow yellowSomething = simpleStore.findObjectByTopicAndClass(topic2, Yellow.class);
