...
public class PlayingStuffGroovy {
    ...
    public void testPlayingSomeStuff() throws Exception {
        ...
        Part part1 = createPart(0F, 20F, nothing.segments.get(3));
        ...
        Part part12 = createPart(19.99F, 32F, nothing.segments.get(3));
        ...
        Part psyltePart = createPart(8F, 16F, psylteFlesk.segments.get(4))
        ...
        Part part2 = createPart(12F, 52F, nothing.segments.get(6))
        ...
        master.addPart(createPart(32F, 62.5F, nothing.segments.get(9)));

        Part part32 = createPart(32F, 62.5F, nothing.segments.get(9));
        master.addEffect(new Rate(1F, 0.9999F, 32F, 62.5F, part32));
        master.addPart(psyltePart);

        master.addPart(createPart(62F, 63.5F, nothing.segments.get(10)));
        master.addPart(createPart(63F, 64.5F, nothing.segments.get(11)));
        master.addPart(createPart(64F, 128F, nothing.segments.get(12)));
        master.addPart(createPart(128F, 256F, nothing.segments.get(14)));
*/
