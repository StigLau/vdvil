...
public class RenderingV2Test {
    ...
    public void play() throws InterruptedException, IOException {
        ...
        conductor.addInstruction(new ImageRenderer(800, 600, downloader), CompositionAdapter.convert(imageParts()));
    ...
    MultimediaPart[] imageParts() throws MalformedURLException {
