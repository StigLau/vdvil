...
public class RendererPlayingTest {
    ...
    public void withRenderer() throws IOException, InterruptedException {
        ...
        Set<RendererToken> renderers = new HashSet<RendererToken>();
        renderers.add(new AudioRenderer(new AudioPlaybackTarget()));
        renderers.add(new ImageRenderer(200, 600, downloadAndParseFacade));
        Renderer renderer = new Renderer(composition, renderers);
        
        renderer.start(beatPattern);
    ...
    public void smokingGunwithAudioRenderer() {
        ...
        audioRenderer.setComposition(composition, beatPattern);
        audioRenderer.run();
    }
