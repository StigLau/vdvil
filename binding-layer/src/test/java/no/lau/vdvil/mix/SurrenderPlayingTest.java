...
public class SurrenderPlayingTest extends SuperPlayingSetup {
    ...
    public void play() throws IOException {
        ...
        super.play(new MasterBeatPattern(128, 256, 150F));
    }
    ...
    protected Composition compose(MasterBeatPattern masterBeatPattern) throws IOException {
        ...
        parts.add(createAudioPart("480-640Surrender", 480, 544, surrenderDvl, downloader)); // Synth X2
        ...
        //parts.add(createAudioPart("1024-1280Surrender", 0, 512, surrenderDvl, downloader));
