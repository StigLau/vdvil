    ...
    Composition quickComposition = new Composition(getClass().getSimpleName(), quickMbp, FileRepresentation.NULL, new CompositionHelper() {
        public List<MultimediaPart> parts() {
            return Arrays.asList(
                    ...
                    createImagePart("0", new Interval(0, 2), store.createKey("http://fc03.deviantart.net/fs17/f/2007/182/f/4/Dead_Teddy_by_Cast_Down_Doll.jpg", "d41d8cd98f00b204e9800998ecf8427e")),
