...
public class CompositionParsingComparsionXmlVsJson {
    ...
    public void xmlVsJsonComparison() throws IOException {
        ...
        checkSomething(xmlComposition.multimediaParts.get(0), "4479230163500364845", 0, 32, 0, new URL("http://kpro09.googlecode.com/svn/trunk/graph-gui-scala/src/main/resources/dvl/olive-youre_not_alone.dvl"));
        checkSomething(jsonComposition.multimediaParts.get(0), "4479230163500364845", 0, 32, 0, new URL("http://kpro09.googlecode.com/svn/trunk/graph-gui-scala/src/main/resources/dvl/olive-youre_not_alone.dvl"));

        checkSomething(xmlComposition.multimediaParts.get(5), "6401936245564505757", 96, 44, 0, new URL("http://kpro09.googlecode.com/svn/trunk/graph-gui-scala/src/main/resources/dvl/holden-nothing-93_returning_mix.dvl"));
        checkSomething(jsonComposition.multimediaParts.get(5), "6401936245564505757", 96, 44, 0, new URL("http://kpro09.googlecode.com/svn/trunk/graph-gui-scala/src/main/resources/dvl/holden-nothing-93_returning_mix.dvl"));

        checkSomething(xmlComposition.multimediaParts.get(13), "5555459205073513470", 224, 28, 0, new URL("http://kpro09.googlecode.com/svn/trunk/graph-gui-scala/src/main/resources/dvl/christian_cambas-it_scares_me.dvl"));
        checkSomething(jsonComposition.multimediaParts.get(13), "5555459205073513470", 224, 28, 0, new URL("http://kpro09.googlecode.com/svn/trunk/graph-gui-scala/src/main/resources/dvl/christian_cambas-it_scares_me.dvl"));
    }
